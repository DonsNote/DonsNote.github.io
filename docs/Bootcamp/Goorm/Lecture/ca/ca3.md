...
**과제 목표:**
선택한 제품/서비스의 타겟 사용자를 대표하는 페르소나를 작성합니다.

**제출 내용:**
1. Primary Persona 1개 (필수 구성 요소 모두 포함)
2. 페르소나 작성을 위해 수행한 리서치 내용
3. 페르소나 기반 주요 기능 우선순위 3가지
4. 데이터 출처 및 근거

---

## 참고 자료
- [3강 개인(그룹)과제 PDF](/assets/pdf/goormca3gw.pdf)
